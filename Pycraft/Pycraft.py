"""
To Do; finish adding themes variable to each subroutine, move up the themes option in settings and repro. PycraftInstaller
"""
...
try:
    ...
    def settings(themeArray, FontCol, BackgroundCol, ShapeCol, rendis, FPS, FOV, cameraANGspeed, devmode, aa, RenderFOG, FanSky, FanPart, sound, soundVOL, music, musicVOL, theme): # defines the setting procedure
        ...
        while True: # main settings loop
            ...
            if My >= 70 and My <= 85 and Mx >= 90 and Mx <= 155:
            ...
            if My >= 70 and My <= 85 and Mx >= 165 and Mx <= 205:
            ...
            if My >= 70 and My <= 85 and Mx >= 215 and Mx <= 300: 
