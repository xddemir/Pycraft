...
try:
    ...
    def DrawSkyBox(camera_x, camera_y, camera_z,Total_move_x, Total_move_y, Total_move_z, firstRUN):
        if firstRUN == 1:
            camera_y -= 50000
    ...
    def main(FontCol, BackgroundCol, ShapeCol, rendis, FPS, FOV, cameraANGspeed, devmode, aa, RenderFOG, Display, LoadingGameImage, G3Dscale, Map, Map_box, min_v, max_v, Map_scale, Map_trans, Map_size, max_Map_size, Load3D):
        ...
        while True:
            ...
            if collisions[0] == False:
                ...
                if collisions[1] < camera_y:
                    Total_move_y -= 1
                elif collisions[1] > camera_y:
                    Total_move_y += 1
            if firstRUN == 1:
            ...
            Total_move_x, Total_move_y, Total_move_z = 0,0,0
            glDisable(GL_DEPTH_TEST)
            DrawSkyBox(camera_x, camera_y, camera_z, Total_move_x, Total_move_y, Total_move_z, firstRUN)
