"""fixed errormessage bug when loading .mp3 files, created a smaller file by removing a redundant image and further compressing sound, increased performance slightly and also started work on the next big update"""
...
try:
    ...
    TitleLoadingFont = pygame.font.Font(os.path.join(base_folder,("Fonts\\Book Antiqua.ttf")), 35) # loads the font used for the graph
