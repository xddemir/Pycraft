...
try:
    ...
    try:
        print("Attempting PyGameInstall")
    ...
    def Installer(Display, titleFont, Name, Version):
        ...
        while True:
            ...
            if location == 2:
                ...
                Display.blit(Version, (1130, 700))
                if counter >= 0:
                    ModulesArray = ["pygame", "pyopengl", "numpy", "pywavefront", "pyautogui", "matplotlib", "psutil", "pyopengl_accelerate"]
                    temp = (5+(1000/len(ModulesArray))*counter+10)
                    line.append((temp, 125))
                    if counter == len(ModulesArray):
                        location += 1
                    try:
                        subprocess.check_call([sys.executable, "-m","pip","install",ModulesArray[counter]], True)
                    except Exception as error:
                        donothing = 0
                    if not counter == (len(ModulesArray)-1):
                        try:
                            ...
                            Progress = InstallerFont.render(f"Installing: PyopenGL-accelerate, Progress: {round(((100/len(ModulesArray))*counter),2)}%", True, (255,255,255))
                else:
            ...
            if location == 3:
                ...
                pygame.draw.lines(Display, (60,60,60), True, [(5,125), (960, 125)], 3)
                pygame.draw.lines(Display, (153, 153, 153), True, line)
                Progress = InstallerFont.render(f"Checking Installer files, this will take a moment, then before completing installation the program will restart.", True, (255,255,255))
                Display.blit(Progress, (5,100))
                pygame.display.flip()
                ...
                data = open(os.path.join(base_folder,("Data_Files\\SaveGameConfig.txt")), "r")
                ...
                data = open(os.path.join(base_folder,("Data_Files\\errorREPORT.txt")), "w")
                ...
                data = pygame.font.Font(os.path.join(base_folder,("Fonts\\Book Antiqua.ttf")), 60)
                ...
                data = pygame.image.load(os.path.join(base_folder,("Resources\\Folder_Resources\\FolderIcon.ico")))
                ...
                data = pywavefront.Wavefront(os.path.join(base_folder,("Resources\\G3_Resources\\Map\\map.obj")), create_materials=True, collect_faces=True)
                ...
                data = pygame.image.load(os.path.join(base_folder,("Resources\\G3_Resources\\skybox\\front.jpg")))
                ...
                data = pygame.image.load(os.path.join(base_folder,("Resources\\G3_Resources\\skybox\\back.jpg")))
                ...
                data = pygame.image.load(os.path.join(base_folder,("Resources\\G3_Resources\\skybox\\left.jpg")))
                ...
                data = pygame.image.load(os.path.join(base_folder,("Resources\\G3_Resources\\skybox\\right.jpg")))
                ...
                data = pygame.image.load(os.path.join(base_folder,("Resources\\G3_Resources\\skybox\\top.jpg")))
                ...
                data = pygame.image.load(os.path.join(base_folder,("Resources\\G3_Resources\\skybox\\bottom.jpg")))
    ...
    def Updater():
        print("Run Updater")
        result = subprocess.check_output([sys.executable, "-m","pip","list", "--outdated"], False)
        print(result)
    ...
    def Uninstaller():
        ...
        while True:
            ...
            if location == 2:
                ...
                Display.blit(Name, (0,690))
                Display.blit(Version, (1130, 700))
                ModulesArray = ["pygame", "pyopengl", "numpy", "pywavefront", "pyautogui", "matplotlib", "psutil", "pillow", "pyopengl_accelerate"]
                if counter == 1:
                    try:
    ...
    while True:
        ...
        try:
            import pygame, numpy, pyautogui, OpenGL, psutil, pywavefront, PIL, OpenGL_accelerate
        except Exception as error:
            unlock = False
        else:
            unlock = True
